...
func TestNewPrivateKeyByHex(t *testing.T) {
	address := "0x93388b4efe13b9b18ed480783c05462409851547"
	prvKeyHex := "95b0a982c0dfc5ab70bf915dcf9f4b790544d25bc5e6cff0f38a59d0bba58651"
	prvKeyBytes := utils.Hex2Bytes(prvKeyHex)
	except := address
...
func TestSign(t *testing.T) {
	prvKeyHex := "95b0a982c0dfc5ab70bf915dcf9f4b790544d25bc5e6cff0f38a59d0bba58651"
	message := utils.Hex2Bytes("9df8dba3720d00bd48ad744722021ef91b035e273bccfb78660ca8df9574b086")
	except := utils.Hex2Bytes("2736b2ca3e2d4778e53a33e0d9bb2d9bad91ec858ab71ad49e31f540f15728a83dbea28bd686bb66d06e4ad9f48912ef437b92a272ea47563c2df80ed59b508e00")
...
func TestPersonalSignAndPersonalSignByPrivateKey(t *testing.T) {
	prvKeyHex := "95b0a982c0dfc5ab70bf915dcf9f4b790544d25bc5e6cff0f38a59d0bba58651"
	message := utils.Hex2Bytes("9df8dba3720d00bd48ad744722021ef91b035e273bccfb78660ca8df9574b086")
	except := utils.Hex2Bytes("aa7cd9f5a7eb485771215d45cc2a4c535e270c75c3595ae6b1c158aef72e67066ad5df037ad5945c65da90edfaa4fe418e5b6bd2225ec9d4b704433a779e4bff00")
...
func TestEcRecover(t *testing.T) {
	sign := utils.Hex2Bytes("2736b2ca3e2d4778e53a33e0d9bb2d9bad91ec858ab71ad49e31f540f15728a83dbea28bd686bb66d06e4ad9f48912ef437b92a272ea47563c2df80ed59b508e00")
	message := Keccak256([]byte("some message"))
	except := utils.Hex2Bytes("0450d7aa97f7496fd412f393e54df0cbe3f6cbeacf15d1ddb12133e408522feb8896dd1652ee84b18788bc7753663302a6489f779352bbfec010ab25c9e3806843")
...
func TestPersonalEcRecover(t *testing.T) {
	address := "0x93388b4efe13b9b18ed480783c05462409851547"
	sign := utils.Hex2Bytes("aa7cd9f5a7eb485771215d45cc2a4c535e270c75c3595ae6b1c158aef72e67066ad5df037ad5945c65da90edfaa4fe418e5b6bd2225ec9d4b704433a779e4bff00")
	message := Keccak256([]byte("some message"))
